...
<%@ page isErrorPage="false" errorPage="chatError.jsp" import="java.util.Set,java.util.Iterator,java.util.Map,java.util.Date,java.text.DateFormat,com.ats.util.*"%>
...
<%
	...
	for(int i = 0; i < chatters.length; i++)
	{
		...
		{
	%>
	<font face="Arial" size="2" color="blue"><%=chatters[i].getName() + " (" +chatters[i].getGender() +")<br>"%></font>
	<%
		}
		else
		{
			out.write("<font face=\"Arial\" size=\"2\"><a href=\"javascript:winopen('viewinfo.jsp?chatterName="+chatters[i].getName() + "')\" title=\"View information about "+chatters[i].getName()+"\">"+ chatters[i].getName()+"</a> (" + chatters[i].getGender()+")</font><br>");
		}
	}
