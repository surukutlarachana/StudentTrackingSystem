...
/**
 * Servlet implementation class WChatBotController
 */
@WebServlet(name = "WChatBot", urlPatterns = { "/wchatbox" })
public class WChatBotController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WChatBotController() {
        super();
